...
Quand on veut créer un vêtement, tout commence par le patron et le tissu. Il faut toujours choisir le bon, l'un en fonction de l'autre.
...
<details>
<summary>1. <u>Utiliser un patron “prêt à l'emploi” </u></summary>

Souvent, ces patrons sont trouvables sur internet ou en mercerie.

S'ils sont achetés en mercerie, ils sont déjà imprimés et prêts à être découpés.

S'ils sont trouvés en ligne, ils viennent souvent sous forme de PDF. Il faut alors généralement l'imprimer feuille par feuille et assembler les pages en suivant les guides.

Dans tous les cas, le patron est composé de plusieurs lignes avec différents motifs.

<img src="/assets/docs/sewing/sewing-1.png" alt="patron-imprime" width="66%"/>&nbsp;<img src="/assets/docs/sewing/sewing-2.png" alt="patron-buste" width="33%"/>

Il faut d'abord déterminer la taille que vous souhaitez utiliser.

:::warning
Les tailles en couture divergent très souvent des tailles des magasins, vous n'êtes pas de la même taille en prêt-à-porter et en couture !
:::

<img src="/assets/docs/sewing/sewing-3.png" alt="table-size-clothes" width="100%"/>

Puis vous devez trouver quelle taille correspond à quel motif :

<img src="/assets/docs/sewing/sewing-4.png" alt="size-line-key" width="100%"/>

Ensuite, vous pouvez soit :

- Découper votre patron en fonction de votre taille (si c'est votre patron)
- Prendre une feuille de patronage et tracer avec une griffe à molette le patron (si vous voulez pouvoir utiliser plusieurs tailles ou que vous utilisez un patron du fablab) puis découper sur la feuille de patronage.

</details>

<details>
<summary>2. <u>Faire votre patron</u></summary>

Si vous n'avez pas de patron qui vous convient, ou que le patron que vous avez trouvé n'existe pas dans votre taille, vous pouvez toujours faire votre propre patron.

Pour cela, vous pouvez utiliser les méthodes suivantes :

<details>
<summary>Le patronage à plat</summary>

Soit en suivant une liste d'instructions, soit en le créant de toute pièce (j'admire si vous y arrivez), vous pouvez tracer vous-même votre patron.\
Pour cela, il vous faut :

- Du papier de patronage (ou un rouleau de grand papier quelconque)
- Un crayon à papier
- Une gomme
- Un stylo
- Un kit de règles de couture (règle japonaise, perroquet, pistolet, etc.)

Je vous conseille fortement de faire votre tracé au crayon puis, une fois fini, repasser sur les tracés importants au stylo.

Vous pouvez ensuite le couper.
</details>

<details>
<summary>Le moulage</summary>

C'est une technique de haute couture qui permet de réaliser un vêtement en trois dimensions.
...
<img src="/assets/docs/sewing/sewing-5.png" alt="shirt-on-manequin" width="100%"/>

:::note
Pour plus d'infos : [Comment réalise-t-on un vêtement en moulage ?](https://lacouturebrigade.com/2020/05/05/comment-realise-t-on-un-vetement-en-moulage/#jp-carousel-12670)
:::

</details>

<details>
<summary>Les techniques “barbares”</summary>

Parfois, on n'a pas de patron et on souhaite éviter les calculs complexes ou le moulage. Dans ce cas, deux techniques alternatives existent mais les maisons de  haute couture vous jugeront... :

<details>
<summary>Patron au scotch</summary>

Cette méthode consiste à s'enrouler de cellophane au-dessus de sous-vêtements ou de vêtements moulants puis de s'enrouler de scotch de peintre.\
Ensuite, on dessine la forme du vêtement que l'on veut faire puis on découpe délicatement le patron pour en sortir (en faisant attention à ne pas couper ses vêtements).\
Enfin, on retire l'excédent de scotch et de cellophane, puis on découpe le patron de manière à obtenir des pièces planes.

:::note
Pour une explication plus détaillée : [How to Make Duct Tape Patterns for Cosplay // Sylvie Cosplay Tutorial Pt. 3](https://www.youtube.com/watch?v=o8_Rqbqx8u4)
:::

</details>

<details>
<summary>Le vol de patron</summary>

Oui, vous avez bien lu.

Cette méthode consiste à reproduire un patron à partir d'un vêtement existant. Pour ce faire, posez un vêtement à votre taille sur un morceau de papier assez large, puis tracez autour en laissant 1 ou 2 cm de marge de couture.

:::note
Pour une explication plus détaillée : [How to Make Patterns from Your Clothes (CLONE YOUR WARDROBE) | WITHWENDY](https://www.youtube.com/watch?v=KeJjB-bdzuI)
:::
</details>
</details>
</details>
...
C'est pourquoi, pour s'assurer qu'on ne coupe pas du tissu cher pour rien, on assemble une première fois notre pièce dans un tissu moins cher que l'on appelle de la toile.
...
Une fois que vous avez préparé votre tissu, vous pouvez passer à l'étape finale.
